...
#import "WebGIFImageView.h"
#import "GIFImage.h"
#import <QuartzCore/QuartzCore.h>

@interface WebGIFImageView ()
...
@implementation WebGIFImageView
...
- (void)setImage:(UIImage *)image
{
    ...
    if ([image isKindOfClass:[GIFImage class]] && image.images) {
...
- (void)setAnimatedImage:(GIFImage *)animatedImage
{
